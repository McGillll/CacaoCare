    ...
    <NuxtLayout name="admin">
        ...
        <div class="mb-4 sm:mb-6 md:mb-8 px-2">
            <div class="flex items-center gap-2 sm:gap-3 mb-2">
                <div
                    class="p-1.5 sm:p-2 bg-gradient-to-r from-green-500 to-emerald-600 rounded-lg"
                >
        ...
        <div
            class="bg-white rounded-xl sm:rounded-2xl shadow-sm border border-gray-100 p-3 sm:p-4 md:p-6 mb-6 sm:mb-8"
        >
        ...
        >
            ...
            >
                ...
                <div class="flex items-center p-3 sm:p-4 border-b">
                    <div
                        class="w-8 h-8 rounded-full bg-gray-200 animate-pulse mr-3"
                    ></div>
                    <div class="flex-1">
                        <div
                            class="h-4 bg-gray-200 rounded w-24 mb-2 animate-pulse"
                        ></div>
                        <div
                            class="h-3 bg-gray-200 rounded w-32 animate-pulse"
                        ></div>
                    </div>
                </div>
                ...
                <div class="relative">
                    <div
                        class="w-full h-40 sm:h-48 bg-gray-200 animate-pulse"
                    ></div>
                    <div
                        class="absolute top-2 right-2 w-20 sm:w-24 h-6 bg-gray-200 rounded animate-pulse"
                    ></div>
                </div>
                ...
                <div class="p-3 sm:p-4">
                    <div
                        class="h-10 bg-gray-200 rounded-xl animate-pulse"
                    ></div>
                </div>
            </div>
        </div>
        ...
        <div class="mt-6 sm:mt-8 flex justify-center px-2">
            <div class="flex justify-center text-xs font-medium space-x-1">
                ...
                <div
                    class="inline-flex items-center justify-center h-8 w-8 bg-green-500 text-white rounded-lg"
                >
                    {{ state.currentPage }}
                </div>
...
import ScanDetailsModal from "@/components/modal/ScanDetailsModal.vue";
