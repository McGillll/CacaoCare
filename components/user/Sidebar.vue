<template>
    <aside class="w-64 bg-white shadow-md p-4">
      <nav>
        <ul class="space-y-2">
          <li>
            <NuxtLink to="/user" class="sidebar-link active">
          ...
          <li>
            <NuxtLink to="/user/upload" class="sidebar-link">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-3" viewBox="0 0 20 20" fill="currentColor">
          ...
          <li>
            <NuxtLink to="/user/treatment" class="sidebar-link">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-3" viewBox="0 0 20 20" fill="currentColor">
          ...
          <li>
            <NuxtLink to="/user/alerts" class="sidebar-link">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-3" viewBox="0 0 20 20" fill="currentColor">
