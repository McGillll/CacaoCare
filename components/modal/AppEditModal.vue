<template>
    ...
    >
        ...
        >
            <div
                v-if="isUpdated"
                class="absolute top-6 right-6 bg-gradient-to-r from-blue-500 to-blue-600 text-white px-6 py-3 rounded-xl shadow-lg flex items-center gap-3 z-60"
            >
                <CheckCircleIcon class="h-5 w-5" />
                <span class="font-medium">Version updated successfully!</span>
            </div>
        </Transition>
        ...
        <div class="relative bg-white rounded-2xl shadow-2xl w-full max-w-lg mx-4 overflow-hidden">
            ...
            >
                <div class="text-center flex w-full h-full flex-col justify-center">
                    ...
                    <p class="text-gray-600 font-medium">Updating app version...</p>
                    <p class="text-sm text-gray-500">Please wait while we save your changes</p>
                </div>
            </div>

            <!-- Header -->
            <div class="bg-gradient-to-r from-blue-50 to-blue-50 px-8 py-6 border-b border-blue-100">
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <h3 class="text-xl font-bold text-gray-900">Edit App Version</h3>
                            <p class="text-sm text-gray-600">Update your CacaoCare app details</p>
                        </div>
                    </div>
                    <button
                        @click="handleClose"
