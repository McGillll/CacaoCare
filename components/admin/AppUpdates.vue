...
import SkeletonloaderStatisticsLoader from '@/components/skeletonloader/StatisticsLoader.vue'
...
function getMostRecentUpdate(): string {
    ...
    const mostRecent = state.downloadLinks.reduce((latest: DownLoadLink, link: DownLoadLink) => {
