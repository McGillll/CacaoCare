<template>
    <div class="min-h-screen bg-gray-50 flex flex-col">
      ...
      <div class="flex flex-1 relative">
        ...
        >
          <div v-if="treatments.length" class="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div
              ...
              :key="treatment.id"
              class="bg-white rounded-xl shadow hover:shadow-lg transition-shadow overflow-hidden cursor-pointer group"
            >
              ...
              <div class="p-5 flex flex-col justify-between flex-1">
                ...
                <div class="mt-4">
                  <button
                    ...
                    class="px-4 py-2 bg-primary-600 text-white text-sm rounded-lg w-full hover:bg-primary-700 transition-all"
                  >
                    View Treatment
                  </button>
                </div>
        ...
        >
          <div
            class="bg-white shadow-xl w-full max-w-xs sm:max-w-lg mx-4 relative overflow-y-auto h-auto max-h-[80vh]"
          >
