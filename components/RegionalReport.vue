...
<!-- Enhanced Welcome Header -->
    <section
        class="relative overflow-hidden bg-gradient-to-r from-emerald-600 via-green-600 to-teal-600 rounded-3xl shadow-2xl"
    >
        <!-- Background Pattern -->
        ...
        <div class="relative p-6 md:p-8">
            ...
            >
                ...
                <div class="flex-1">
                    <div class="flex items-center mb-4">
                        <div>
                            ...
                            >
                                Regional
                                <span class="text-green-200">Alerts</span>
                            </h1>
                            <div
                                class="h-1 w-24 bg-gradient-to-r from-green-200 to-emerald-200 rounded-full"
                            ></div>
                        </div>
                    </div>

                    <p
                        class="text-green-50 text-xl mb-6 max-w-2xl leading-relaxed"
                    >
                    ...
                    <div class="flex flex-wrap gap-4 mb-6">
                        <div
                            class="flex items-center bg-white bg-opacity-15 rounded-full px-4 py-2 backdrop-blur-sm"
                        >
                            <div
                                class="w-3 h-3 bg-green-300 rounded-full mr-3 animate-pulse"
                            ></div>
                        ...
                        >
                            <svg
                                class="w-4 h-4 text-green-200 mr-2"
                                fill="currentColor"
                                viewBox="0 0 20 20"
                            >
                                <path
                            ...
                            <span
                                class="text-green-50 text-sm font-medium"
                                >{{
                ...
                <div class="flex-shrink-0">
                    <div
                        class="bg-white bg-opacity-20 hover:bg-opacity-30 rounded-2xl p-4 text-white transition-all duration-300 backdrop-blur-sm border border-white border-opacity-20 hover:border-opacity-40"
                    >
                        <label
                            class="block text-green-100 text-sm font-medium mb-2"
                            >Select Year</label
                        >
                        <select
    ...
    >
        <!-- Black Pod Rot Card -->
        <div
            class="group bg-white rounded-3xl shadow-sm hover:shadow-xl transition-all duration-500 overflow-hidden border border-gray-100"
        >
            <div
                class="relative bg-gradient-to-br from-red-500 to-red-700 p-4"
            >
                <!-- Decorative elements -->
                <div
                    class="absolute top-0 right-0 w-24 h-24 bg-white opacity-10 rounded-full transform translate-x-8 -translate-y-8"
                ></div>
                <div
                    class="absolute bottom-0 left-0 w-16 h-16 bg-white opacity-10 rounded-full transform -translate-x-8 translate-y-8"
                ></div>

                <div class="relative flex justify-between items-start">
                    <div>
                        <div
                            class="text-xs font-medium text-red-100 uppercase tracking-wider mb-1"
                        >
                            Disease Alert
                        </div>
            ...
            <div class="p-4">
                ...
                <div class="h-2 bg-gray-100 rounded-full overflow-hidden">
                    <div
                        ...
                        :style="{
                            width: state.overview[0].percentage + '%',
                        }"
                    ></div>
                </div>
                <div class="mt-1 text-xs text-gray-500">
                    {{ Math.round(state.overview[0].percentage) }}% of total
                    alerts
                </div>
            </div>
        </div>
        ...
        >
            <div
                class="relative bg-gradient-to-br from-green-500 to-green-700 p-4"
            >
                <!-- Decorative elements -->
                <div
                    class="absolute top-0 right-0 w-24 h-24 bg-white opacity-10 rounded-full transform translate-x-8 -translate-y-8"
                ...
                <div class="relative flex justify-between items-start">
                    <div>
                        <div
                            class="text-xs font-medium text-green-100 uppercase tracking-wider mb-1"
                        >
                            Disease Alert
                        </div>
                        <h3 class="text-xl font-bold text-white">
            ...
            <div class="p-4">
                ...
                <div class="h-2 bg-gray-100 rounded-full overflow-hidden">
                    <div
                        ...
                        :style="{
                            width: state.overview[1].percentage + '%',
                        }"
                    ></div>
                </div>
                <div class="mt-1 text-xs text-gray-500">
                    {{ Math.round(state.overview[1].percentage) }}% of total
                    alerts
                </div>
            </div>
        </div>
        ...
        >
            ...
            >
                ...
                >
                    ...
                    <div
                        v-if="isMapVisual"
                        class="absolute inset-0 bg-gradient-to-r from-emerald-500 to-green-600 transition-all duration-500"
                    ></div>
                ...
                >
                    ...
                    <div
                        v-if="!isMapVisual"
                        class="absolute inset-0 bg-gradient-to-r from-blue-500 to-indigo-600 transition-all duration-500"
                    ></div>
                    ...
                    >
                        ...
                        >
                            <path
                                d="M3.5 18.49l6-6.01 4 4L22 6.92l-1.41-1.41-7.09 7.97-4-4L3.5 15.99z"
                            />
                        </svg>
    ...
    <div class="grid grid-cols-1 gap-6">
        ...
        <div
            v-if="isMapVisual"
            class="group bg-white rounded-3xl shadow-xl border border-gray-100 overflow-hidden hover:shadow-2xl transition-all duration-500"
        >
            <div
                class="relative bg-gradient-to-br from-emerald-600 via-green-600 to-teal-700 px-6 py-6"
            >
                <!-- Decorative elements -->
                <div
                    class="absolute top-0 right-0 w-32 h-32 bg-white opacity-5 rounded-full transform translate-x-16 -translate-y-16"
                ></div>
                <div
                ...
                <div
                    class="relative flex flex-col lg:flex-row lg:items-center lg:justify-between space-y-4 lg:space-y-0"
                >
                    <div class="flex items-center space-x-4">
                        ...
                        <div>
                            ...
                            <p class="text-green-100 text-sm">
                                Geographic distribution of cacao diseases
                            </p>
                        </div>
                    </div>
            ...
            <div
                class="p-6 lg:p-8 bg-gradient-to-br from-gray-50 to-green-50"
            >
                <!-- Map Container -->
                <div
                    class="h-[450px] rounded-2xl overflow-hidden shadow-inner bg-white"
                >
                    <CacaoMap
                        :heatPoints="state?.heatpoints"
                        :total-uploaders="state.totalUserUpload"
                        class="w-full h-full"
                    />
                </div>
            </div>
        ...
        >
            <div v-if="false" class="animate-pulse">
                <div
                    class="bg-gradient-to-r from-gray-300 to-gray-400 h-24 rounded-t-3xl"
                />
                <div class="p-6 lg:p-8">
                    <div
                        class="bg-gradient-to-r from-gray-200 to-gray-300 h-96 rounded-2xl"
                    />
                </div>
            </div>
            <div v-else>
                <div
                    class="relative bg-gradient-to-br from-blue-600 via-indigo-600 to-purple-700 px-6 py-6"
                >
                    <!-- Decorative elements -->
                    <div
                        class="absolute top-0 right-0 w-32 h-32 bg-white opacity-5 rounded-full transform translate-x-16 -translate-y-16"
                ...
                <div
                    class="p-6 lg:p-8 bg-gradient-to-br from-gray-50 to-indigo-50"
                >
                    <!-- Chart Container -->
                    <div class="relative">
                        <div class="overflow-x-auto custom-scrollbar pb-2">
                            <div
                                class="h-[350px] md:h-[400px] lg:h-[450px] min-w-[800px] rounded-2xl overflow-hidden shadow-inner bg-white"
                            >
                                <ChartLineYearly
                                    :data="state.trend"
                                    class="h-full w-full"
                        ...
                        <div
                            class="md:hidden absolute bottom-2 right-4 bg-indigo-600 text-white text-xs px-2 py-1 rounded-full opacity-80 animate-pulse"
                        >
                    ...
                    <!-- Analysis Summary -->
                    <div
                        class="mt-4 bg-indigo-50 p-4 rounded-xl border border-indigo-100"
                    >
                        <div class="flex items-start space-x-3">
                            ...
                            <div>
                                ...
                                <p class="mt-1 text-sm text-indigo-700">
                                    The chart shows disease progression
                                    patterns over time. Use this data to
                                    identify seasonal trends and implement
                                    preventive measures for your cacao
                                    plants.
                                </p>
                            </div>
                        </div>
    ...
    >
            ...
            >
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        ...
                        <p class="text-indigo-100 text-sm">
                            Disease alerts by geographic region
                        </p>
                    </div>
                </div>
                ...
                <div class="flex items-center space-x-3">
                    <div
                        class="px-3 py-1 bg-white bg-opacity-20 rounded-lg text-white text-sm font-medium backdrop-blur-sm"
                    >
                        <span
                            >{{ state.regionStatus.length }} Affected
                            Regions</span
                        >
                    </div>
                </div>
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    <tr
                        v-for="alert in state.regionStatus"
                        :key="alert.region"
        ...
        <div
            v-if="state.regionStatus.length === 0"
        ...
        >
            ...
            <p class="text-sm text-gray-500 max-w-md mx-auto">
                Your region currently has no active disease alerts. Check
                back later for updates.
            </p>
        </div>

        <div
            class="border-t border-gray-200 px-6 py-4 bg-gray-50 flex flex-col sm:flex-row items-center justify-between gap-4"
        >
            <div class="text-sm text-gray-500">
                Showing <span class="font-medium">{{ startItem }}</span> to
                <span class="font-medium">{{ endItem }}</span> of
                <span class="font-medium">{{
                    state.regionStatus.length
                }}</span>
                results
            </div>
    ...
    >
        <div
            class="bg-white overflow-hidden shadow-xl w-full max-w-4xl relative rounded-xl max-h-[90vh] flex flex-col"
        >
            <!-- Modal Header with Gradient -->
            <div
                class="relative bg-gradient-to-r from-emerald-50 to-teal-50 p-3 md:p-5 border-b border-emerald-100 flex justify-between items-center"
            >
                <!-- Decorative Elements -->
                <div
                    class="absolute top-0 right-0 w-24 md:w-32 h-24 md:h-32 opacity-10"
                >
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 24 24"
                        class="w-full h-full text-emerald-800"
                    >
                        <path
                            fill="currentColor"
                ...
                <div class="flex items-center max-w-[80%]">
                    <div
                        class="w-1 h-6 md:h-8 bg-emerald-500 rounded-full mr-2 md:mr-3 flex-shrink-0"
                    ></div>
                    <h3
                        class="text-base md:text-xl font-bold text-gray-800 truncate"
                    >
                        Disease Analysis:
                        {{ state.selectedRegionStatus?.region }}
                    </h3>
                </div>
                ...
                <button
                    @click="
                        () => {
                            state.selectedRegionStatus?.affectedCities.forEach(
                                (city) => {
                                    city.selected = false;
                                },
                            );
            ...
            <!-- Stats Summary Grid -->
            <div
                class="grid grid-cols-2 md:grid-cols-4 gap-2 md:gap-4 p-3 md:p-4 bg-gray-50"
            >
                <div
                    class="bg-white p-2 md:p-3 rounded-lg shadow-sm border border-gray-100"
                >
                    <div
                        class="text-xs text-gray-500 uppercase tracking-wider truncate"
                    >
                        Total Affected
                    </div>
                    <div
                        class="text-base md:text-xl font-bold text-gray-800 mt-1"
                    >
                        {{
                            state.selectedRegionStatus?.totalUserAffected ||
                            0
                        }}
                    </div>
                </div>
                ...
                >
                    ...
                    >
                        {{
                            state.selectedRegionStatus?.affectedCities
                                .length || 0
                        }}
                    </div>
                </div>
            ...
            <!-- Graph Visual -->
            <div
                class="p-3 md:p-5 bg-white relative overflow-y-auto custom-scrollbar flex-1"
            >
                <div class="flex flex-col md:flex-row gap-4 md:gap-6">
                    <!-- Chart Container -->
                    <div
                        class="w-full md:w-3/5 bg-gradient-to-br from-gray-50 to-white rounded-xl shadow-sm p-3 md:p-4 border border-gray-100"
                    >
                        <h4
                            class="text-sm font-medium text-gray-700 mb-2 md:mb-3"
                        >
                        ...
                        <div
                            v-if="!hasSelectedCity"
                            class="h-64 rounded-lg overflow-hidden flex flex-col items-center justify-center bg-gray-50 border border-dashed border-gray-200"
                        >
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                            ...
                            <p
                                class="text-sm text-gray-500 text-center max-w-xs"
                            >
                                Select a city from the list to view disease
                                trend analysis
                            </p>
                        </div>
                        ...
                        <div v-else class="h-64 rounded-lg overflow-hidden">
                            <ChartLineYearly
                                ...
                                :city="
                                    state.selectedRegionStatus?.affectedCities.find(
                                        (city) => city.selected,
                                    )?.name || ''
                                "
                                :region="
                        ...
                        <!-- Chart Legend -->
                        <div
                            class="mt-2 md:mt-4 flex flex-wrap justify-start gap-3 md:gap-6"
                        >
                            <div class="flex items-center space-x-2">
                                <div
                    ...
                    <div class="w-full md:w-2/5">
                        <h4
                            class="text-sm font-medium text-gray-700 mb-2 md:mb-3 flex items-center"
                        >
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                        ...
                        <div
                            class="max-h-48 sm:max-h-56 md:max-h-64 overflow-y-auto pr-2 custom-scrollbar"
                        >
                            <div class="grid grid-cols-1 gap-2">
                                <div
                                    ...
                                    "
                                    :class="[
                                        'px-2 md:px-3 py-2 rounded-lg font-medium border transition-all duration-200 flex flex-col sm:flex-row sm:justify-between sm:items-center gap-1 sm:gap-0',
                                        area.selected
                                ...
                                >
                                    ...
                                    <span
                                        class="text-xs sm:text-sm px-2 py-1 rounded-full bg-emerald-100 text-emerald-700 whitespace-nowrap"
                                        >{{
                                            area.userAffected
                                        }}
                                        affected</span
...
async function fetchYearOptions() {
    try {
        ...
        if (response.data) {
            ...
            state.year.selected =
                state.year.options[0] || new Date().getFullYear().toString();
        }
    } catch (error) {
...
async function fetchCacaoYearlyGraph() {
    try {
        ...
        formdata.append(
            "year",
            state.year.selected || new Date().getFullYear().toString(),
        );
...
async function fetchCacaoYearlyGraphForCity(cityName: string) {
    try {
        ...
        console.error(
            `Error fetching yearly graph data for ${cityName}:`,
            error,
        );
    }
}
...
async function fetchHeatMapData() {
    try {
        ...
        const response = await cacaoServices.getYearlyHeatMapData(
...
async function fetchRegionData() {
    try {
        const response = await cacaoServices.getRegionalAlertData(
            state.year.selected,
        );
        if (response.data) {
            state.total.diseased = response.data.total_diseased_uploads || 0;
            state.overview[0].affected =
                response.data.total_blackpod_uploads || 0;
            state.overview[1].affected =
                response.data.total_frostypod_uploads || 0;
            state.overview[0].percentage =
                (state.overview[0].affected / state.total.diseased) * 100 || 0;
            state.overview[1].percentage =
                (state.overview[1].affected / state.total.diseased) * 100 || 0;
